...
namespace Snake
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            music.PlayMusic(@"C:\Users\User\source\repos\Snake-master\Snake_Game\fon.wav");
            while (on)
            {
                                ...
                                case "music":
                                    ...
                                    switch (options.music)
                                    {
                                        case 1:
                                            ...
                                            music.PlayMusic(@"C:\Users\User\source\repos\Snake-master\Snake_Game\fon1.wav");
                                            break;
                                        case 2:
                                            options.music = 2;
                                            options.playing_music = "Выбранная музыка: Fon2";
                                            music.PlayMusic(@"C:\Users\User\source\repos\Snake-master\Snake_Game\fon2.wav");
                                            break;
                                        case 3:
                                            options.music = 3;
                                            options.playing_music = "Выбранная музыка: Fon";
                                            music.PlayMusic(@"C:\Users\User\source\repos\Snake-master\Snake_Game\fon3.wav");
                                            break;
                                    }
                                    break;
                                case "value":
                ...
                while (gameOn)
                {
                    ...
                    if (snake.Eat(food))
                    {
                        music.Play(@"C:\Users\User\source\repos\Snake-master\Snake_Game\eat.wav");
                        Console.ForegroundColor = ConsoleColor.Red;
